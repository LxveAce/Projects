#!/usr/bin/env python3
"""
Headless Marauder GUI — a native Tkinter desktop application for Kali Linux.
...
# Make `marauder_core` importable whether launched as a script or a module.
...
def main():
    ap = argparse.ArgumentParser(description="Headless Marauder GUI (Tkinter desktop app)")
